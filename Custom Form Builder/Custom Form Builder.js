...
formArea.addEventListener('drop', e => {
  ...
  const type = e.dataTransfer.getData('type');
    ...
    if (type === 'input') {
        ...
        inputWrapper.style.padding = '40px'; // Padding inside the wrapper
  ...
  //                                                HEADING CREATION
    ...
    headingWrapper.style.border = '1px solid #ddd';
    headingWrapper.style.borderRadius = '8px'; // Rounded corners
    headingWrapper.style.padding = '40px'; // Padding inside the wrapper
  ...
  //                                                DESCRIPTION CREATION
    ...
    descriptionWrapper.style.marginBottom = '30px';
    descriptionWrapper.style.backgroundColor = '#f9f9f9'; // Light background color
    descriptionWrapper.style.border = '1px solid #ddd';
    descriptionWrapper.style.borderRadius = '8px'; // Rounded corners
    descriptionWrapper.style.padding = '40px'; // Padding inside the wrapper
...
`;
    ...
    document.getElementById('save-radio-group').addEventListener('click', () => {
        ...
        radioGroupWrapper.style.marginBottom = '30px';
        radioGroupWrapper.style.backgroundColor = '#f9f9f9'; // Light background color
        radioGroupWrapper.style.border = '1px solid #ddd';
        radioGroupWrapper.style.padding = '40px';
...
//                                                    CHECKBOX GROUP 
    ...
    document.getElementById('save-checkbox-group').addEventListener('click', () => {
        ...
        checkboxGroupWrapper.style.border = '1px solid #ddd';
        checkboxGroupWrapper.style.padding = '40px';
...
//                                                     SHORT ANSWER
    ...
    document.getElementById('save-label').addEventListener('click', () => {
        ...
        shortAnswerWrapper.style.border = '1px solid #ddd';
        shortAnswerWrapper.style.marginBottom = '30px';
        shortAnswerWrapper.style.padding = '40px';
...
//                                                     LONG ANSWER
    ...
    document.getElementById('save-label').addEventListener('click', () => {
        ...
        longAnswerWrapper.style.marginBottom = '30px';
        longAnswerWrapper.style.border = '1px solid #ddd';
        longAnswerWrapper.style.padding = '40px';
    ...
    emailWrapper.style.border = '1px solid #ddd';
    emailWrapper.style.marginBottom = '30px';
    emailWrapper.style.padding = '40px';
...
//                                                     FILE UPLOAD
    ...
    document.getElementById('save-file-upload').addEventListener('click', () => {
        ...
        fileUploadWrapper.style.marginBottom = '30px';
        fileUploadWrapper.style.padding = '40px';
        fileUploadWrapper.style.border = '1px solid #ddd';
...
//                                                   FULL NAME FIELDS 
    ...
    nameWrapper.style.border = '1px solid #ddd';
    nameWrapper.style.backgroundColor = '#f9f9f9'; // Light background color
    nameWrapper.style.borderRadius = '10px'; // Rounded corners
    nameWrapper.style.padding = '40px'; // Padding for a clean layout
    nameWrapper.style.marginBottom = '30px';
...
//                                                    MULTIPLE TEXTBOXES
    ...
    addButton.addEventListener('click', () => {
        ...
        elementWrapper.style.border = '1px solid #ddd';
        elementWrapper.style.padding = '40px';
  ...
  //                                                           NPS
    ...
    npsWrapper.style.marginBottom = '30px';
    npsWrapper.style.border = '1px solid #ddd';
    npsWrapper.style.backgroundColor = '#f9f9f9';
    npsWrapper.style.padding = '40px';
  ...
  //                                                          SLIDER
    ...
    addButton.addEventListener('click', () => {
        ...
        sliderWrapper.style.padding = '40px';
        sliderWrapper.style.flexDirection = 'column';
        sliderWrapper.style.gap = '10px';
        sliderWrapper.style.marginTop = '10px';
        sliderWrapper.style.marginBottom = '30px';
        sliderWrapper.style.border = '1px solid #ddd'
  ...
  //                                                       IMAGE SELECTOR
    ...
    nextButton1.addEventListener('click', () => {
        ...
        submitButton.addEventListener('click', () => {
            ...
            imageSelectorWrapper.style.padding = '40px';
            imageSelectorWrapper.style.backgroundColor = '#f9f9f9';
            imageSelectorWrapper.style.border = '1px solid #ddd'
            imageSelectorWrapper.style.borderRadius = '8px';
            imageSelectorWrapper.style.marginBottom = '30px';
  ...
  //                                                          RATING SCALE
    ...
    ratingWrapper.style.padding = '40px';
    ratingWrapper.style.backgroundColor = '#f9f9f9';
    ratingWrapper.style.border = '1px solid #ddd'
  ...
  //                                                          STAR RATING
    ...
    starWrapper.style.padding = '40px';
    starWrapper.style.backgroundColor = '#f9f9f9';
    starWrapper.style.border = '1px solid #ddd'
  ...
  //                                                       MATRIX TEXT BOXES
    ...
    modalButton.addEventListener('click', () => {
        ...
        matrixWrapper.style.padding = '40px';
        matrixWrapper.style.border = '1px solid #ddd'
  ...
  //                                                         UPLOAD SIGNATURE
    ...
    drawingSection.style.width = '100%';
    drawingSection.style.height = '100%';
...
signatureCanvasWrapper.appendChild(signatureCanvas);
  ...
  //                                                         CONTINNOUS SUM
    ...
    saveButton.addEventListener('click', function () {
        ...
        outputWrapper.style.padding = '40px';
        outputWrapper.style.border = '1px solid #ddd';
